...
var DUMMYRNG = /** @class */ (function () {
    function DUMMYRNG(forceValue) {
        var _this = this;
        if (forceValue === void 0) { forceValue = -1; }
        ...
        this.getRandomInt = function (input) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (res, rej) {
                        try {
                            if (_this.forceValue != -1) {
                                res(_this.forceValue);
                            }
                            res(Math.floor(input.min + (1 + input.max - input.min) * Math.random()));
                        }
                        catch (e) {
                            rej(e);
                        }
    ...
    DUMMYRNG.prototype.uid = function () {
        return 'uid()';
    };
    return DUMMYRNG;
}());
exports.default = DUMMYRNG;
