...
server.on('connection', function (socket) {
    ...
    var gameLogic = __1.default.createGameLogicAndWallet(new dummyRNG_1.default());
    var initialMsg = JSON.stringify(gameLogic.initialMsg);
            ...
            return __generator(this, function (_f) {
                switch (_f.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, __1.default.play(gameLogic.specificGame, gameLogic.wallet, meta, input.gameInput.hasOwnProperty('actionInput')
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, __1.default.bet(gameLogic.specificGame, input.gameInput.actionInput.direction, gameLogic.wallet, meta)];
                    case 3:
