...
function getField(key) {
    ...
    if (gameMsgData.hasOwnProperty(lang)) {
        var langTexts = gameMsgData[lang];
...
function getLanguageTextGameMsg(key) {
...
exports.getLanguageTextGameMsg = getLanguageTextGameMsg;
function getGameMsgData() {
    return gameMsgData;
}
exports.getGameMsgData = getGameMsgData;
var gameMsgData = {
    en: {
        autospin: {
            text: "AUTOSPIN"
